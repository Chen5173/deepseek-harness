...
export const zh = {
  ...
  'timeGroup.week': '前 7 天',
  'timeGroup.month': '前 30 天',
  'timeGroup.older': '更早',
  'timeGroup.showWorkspace': '显示工作区',
  'orderBy.label': '排序方式',
  'orderBy.manual': '手动排序',
  ...
  'rename': '重命名',
  'menu.regenerateTitle': '重新生成标题',
  'menu.openWorkspaceFolder': '打开工作区目录',
...
export const en = {
  ...
  'groupBy.time': 'By time',
  'timeGroup.today': 'Today',
  'timeGroup.yesterday': 'Yesterday',
  'timeGroup.week': 'Previous 7 days',
  'timeGroup.month': 'Previous 30 days',
  'timeGroup.older': 'Older',
  'timeGroup.showWorkspace': 'Show workspace',
  ...
  'menu.openWorkspaceFolder': 'Open workspace folder',
